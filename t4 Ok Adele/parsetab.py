...
_lr_productions = [
  ...
  ('programa -> declaracao_list','programa',1,'p_programa','compilador.py',149),
  ('declaracao_list -> declaracao_list declaracao','declaracao_list',2,'p_declaracao_list','compilador.py',153),
  ('declaracao_list -> declaracao','declaracao_list',1,'p_declaracao_list','compilador.py',154),
  ('declaracao -> declaracao_variavel','declaracao',1,'p_declaracao','compilador.py',161),
  ('declaracao -> declaracao_funcao','declaracao',1,'p_declaracao','compilador.py',162),
  ('declaracao -> estrutura_controle','declaracao',1,'p_declaracao','compilador.py',163),
  ('declaracao -> comentario','declaracao',1,'p_declaracao','compilador.py',164),
  ('declaracao -> expressao SEMICOLON','declaracao',2,'p_declaracao','compilador.py',165),
  ('declaracao_variavel -> tipo ID SEMICOLON','declaracao_variavel',3,'p_declaracao_variavel','compilador.py',169),
  ('declaracao_variavel -> tipo ID EQUALS expressao SEMICOLON','declaracao_variavel',5,'p_declaracao_variavel','compilador.py',170),
  ('tipo -> INT','tipo',1,'p_tipo','compilador.py',184),
  ('tipo -> FLOAT','tipo',1,'p_tipo','compilador.py',185),
  ('tipo -> DOUBLE','tipo',1,'p_tipo','compilador.py',186),
  ('tipo -> CHAR','tipo',1,'p_tipo','compilador.py',187),
  ('tipo -> BOOLEAN','tipo',1,'p_tipo','compilador.py',188),
  ('tipo -> VOID','tipo',1,'p_tipo','compilador.py',189),
  ('declaracao_funcao -> tipo ID LPAREN parametros RPAREN bloco','declaracao_funcao',6,'p_declaracao_funcao','compilador.py',193),
  ('parametros -> parametro','parametros',1,'p_parametros','compilador.py',197),
  ('parametros -> parametro COMMA parametros','parametros',3,'p_parametros','compilador.py',198),
  ('parametros -> vazio','parametros',1,'p_parametros','compilador.py',199),
  ('parametro -> tipo ID','parametro',2,'p_parametro','compilador.py',208),
  ('parametro -> tipo ID LBRACKET RBRACKET','parametro',4,'p_parametro','compilador.py',209),
  ('parametro -> tipo DOTS ID','parametro',3,'p_parametro','compilador.py',210),
  ('bloco -> LBRACE declaracao_list RBRACE','bloco',3,'p_bloco','compilador.py',219),
  ('estrutura_controle -> if','estrutura_controle',1,'p_estrutura_controle','compilador.py',223),
  ('estrutura_controle -> while','estrutura_controle',1,'p_estrutura_controle','compilador.py',224),
  ('estrutura_controle -> for','estrutura_controle',1,'p_estrutura_controle','compilador.py',225),
  ('estrutura_controle -> switch','estrutura_controle',1,'p_estrutura_controle','compilador.py',226),
  ('if -> IF LPAREN expressao RPAREN bloco','if',5,'p_if','compilador.py',230),
  ('while -> WHILE LPAREN expressao RPAREN bloco','while',5,'p_while','compilador.py',234),
  ('for -> FOR LPAREN expressao SEMICOLON expressao SEMICOLON expressao RPAREN bloco','for',9,'p_for','compilador.py',238),
  ('switch -> SWITCH LPAREN expressao RPAREN LBRACE case_list RBRACE','switch',7,'p_switch','compilador.py',242),
  ('case_list -> case_list case','case_list',2,'p_case_list','compilador.py',246),
  ('case_list -> case','case_list',1,'p_case_list','compilador.py',247),
  ('case -> CASE expressao COLON declaracao_list','case',4,'p_case','compilador.py',254),
  ('case -> DEFAULT COLON declaracao_list','case',3,'p_case','compilador.py',255),
  ('comentario -> COMMENT','comentario',1,'p_comentario','compilador.py',262),
  ('comentario -> MULTI_COMMENT','comentario',1,'p_comentario','compilador.py',263),
  ('expressao -> ID','expressao',1,'p_expressao','compilador.py',267),
  ('expressao -> NUM_INT','expressao',1,'p_expressao','compilador.py',268),
  ('expressao -> NUM_DEC','expressao',1,'p_expressao','compilador.py',269),
  ('expressao -> TEXTO','expressao',1,'p_expressao','compilador.py',270),
  ('expressao -> ID EQUALS expressao','expressao',3,'p_expressao','compilador.py',271),
  ('expressao -> expressao PLUS expressao','expressao',3,'p_expressao','compilador.py',272),
  ('expressao -> expressao MINUS expressao','expressao',3,'p_expressao','compilador.py',273),
  ('expressao -> expressao TIMES expressao','expressao',3,'p_expressao','compilador.py',274),
  ('expressao -> expressao DIV expressao','expressao',3,'p_expressao','compilador.py',275),
  ('expressao -> expressao MOD expressao','expressao',3,'p_expressao','compilador.py',276),
  ('expressao -> LPAREN expressao RPAREN','expressao',3,'p_expressao','compilador.py',277),
  ('expressao -> PRINTLN LPAREN TEXTO RPAREN','expressao',4,'p_expressao','compilador.py',278),
  ('vazio -> <empty>','vazio',0,'p_vazio','compilador.py',311),
]
