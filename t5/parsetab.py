...
_lr_productions = [
  ...
  ('programa -> declaracao_list','programa',1,'p_programa','cod.py',149),
  ('declaracao_list -> declaracao_list declaracao','declaracao_list',2,'p_declaracao_list','cod.py',153),
  ('declaracao_list -> declaracao','declaracao_list',1,'p_declaracao_list','cod.py',154),
  ('declaracao -> declaracao_variavel','declaracao',1,'p_declaracao','cod.py',161),
  ('declaracao -> declaracao_funcao','declaracao',1,'p_declaracao','cod.py',162),
  ('declaracao -> estrutura_controle','declaracao',1,'p_declaracao','cod.py',163),
  ('declaracao -> comentario','declaracao',1,'p_declaracao','cod.py',164),
  ('declaracao -> expressao SEMICOLON','declaracao',2,'p_declaracao','cod.py',165),
  ('declaracao_variavel -> tipo ID SEMICOLON','declaracao_variavel',3,'p_declaracao_variavel','cod.py',169),
  ('declaracao_variavel -> tipo ID EQUALS expressao SEMICOLON','declaracao_variavel',5,'p_declaracao_variavel','cod.py',170),
  ('tipo -> INT','tipo',1,'p_tipo','cod.py',184),
  ('tipo -> FLOAT','tipo',1,'p_tipo','cod.py',185),
  ('tipo -> DOUBLE','tipo',1,'p_tipo','cod.py',186),
  ('tipo -> CHAR','tipo',1,'p_tipo','cod.py',187),
  ('tipo -> BOOLEAN','tipo',1,'p_tipo','cod.py',188),
  ('tipo -> VOID','tipo',1,'p_tipo','cod.py',189),
  ('declaracao_funcao -> tipo ID LPAREN parametros RPAREN bloco','declaracao_funcao',6,'p_declaracao_funcao','cod.py',193),
  ('parametros -> parametro','parametros',1,'p_parametros','cod.py',197),
  ('parametros -> parametro COMMA parametros','parametros',3,'p_parametros','cod.py',198),
  ('parametros -> vazio','parametros',1,'p_parametros','cod.py',199),
  ('parametro -> tipo ID','parametro',2,'p_parametro','cod.py',208),
  ('parametro -> tipo ID LBRACKET RBRACKET','parametro',4,'p_parametro','cod.py',209),
  ('parametro -> tipo DOTS ID','parametro',3,'p_parametro','cod.py',210),
  ('bloco -> LBRACE declaracao_list RBRACE','bloco',3,'p_bloco','cod.py',219),
  ('estrutura_controle -> if','estrutura_controle',1,'p_estrutura_controle','cod.py',223),
  ('estrutura_controle -> while','estrutura_controle',1,'p_estrutura_controle','cod.py',224),
  ('estrutura_controle -> for','estrutura_controle',1,'p_estrutura_controle','cod.py',225),
  ('estrutura_controle -> switch','estrutura_controle',1,'p_estrutura_controle','cod.py',226),
  ('if -> IF LPAREN expressao RPAREN bloco','if',5,'p_if','cod.py',230),
  ('while -> WHILE LPAREN expressao RPAREN bloco','while',5,'p_while','cod.py',234),
  ('for -> FOR LPAREN expressao SEMICOLON expressao SEMICOLON expressao RPAREN bloco','for',9,'p_for','cod.py',238),
  ('switch -> SWITCH LPAREN expressao RPAREN LBRACE case_list RBRACE','switch',7,'p_switch','cod.py',242),
  ('case_list -> case_list case','case_list',2,'p_case_list','cod.py',246),
  ('case_list -> case','case_list',1,'p_case_list','cod.py',247),
  ('case -> CASE expressao COLON declaracao_list','case',4,'p_case','cod.py',254),
  ('case -> DEFAULT COLON declaracao_list','case',3,'p_case','cod.py',255),
  ('comentario -> COMMENT','comentario',1,'p_comentario','cod.py',262),
  ('comentario -> MULTI_COMMENT','comentario',1,'p_comentario','cod.py',263),
  ('expressao -> ID','expressao',1,'p_expressao','cod.py',267),
  ('expressao -> NUM_INT','expressao',1,'p_expressao','cod.py',268),
  ('expressao -> NUM_DEC','expressao',1,'p_expressao','cod.py',269),
  ('expressao -> TEXTO','expressao',1,'p_expressao','cod.py',270),
  ('expressao -> ID EQUALS expressao','expressao',3,'p_expressao','cod.py',271),
  ('expressao -> expressao PLUS expressao','expressao',3,'p_expressao','cod.py',272),
  ('expressao -> expressao MINUS expressao','expressao',3,'p_expressao','cod.py',273),
  ('expressao -> expressao TIMES expressao','expressao',3,'p_expressao','cod.py',274),
  ('expressao -> expressao DIV expressao','expressao',3,'p_expressao','cod.py',275),
  ('expressao -> expressao MOD expressao','expressao',3,'p_expressao','cod.py',276),
  ('expressao -> LPAREN expressao RPAREN','expressao',3,'p_expressao','cod.py',277),
  ('expressao -> PRINTLN LPAREN TEXTO RPAREN','expressao',4,'p_expressao','cod.py',278),
  ('vazio -> <empty>','vazio',0,'p_vazio','cod.py',312),
]
